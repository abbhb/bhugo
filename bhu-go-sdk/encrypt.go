...
//	"https://webvpn.beihua.edu.cn/http/77726476706e69737468656265737421a2a618d275613e1e275ec7f8/eams/homeExt.action"
func EncryptURLToWebVPN(url string) string {
	...
	if len(port) > 0 {
		return fmt.Sprintf("https://webvpn.beihua.edu.cn/%s-%s/%s", protocol, port, url)
	}

	return fmt.Sprintf("https://webvpn.beihua.edu.cn/%s/%s", protocol, url)
}
